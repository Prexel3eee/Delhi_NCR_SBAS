...
CAPTIONS = {
    "F1": (
        ...
        "(H001–H005), which are small relative to the AOI. "
    ...
    "F2": (
        ...
        "indicates motion away. (B) Distribution of the same field on a log count scale; dashed "
        "line is the median. "
    ...
    "F3": (
        ...
        "*Sample definition:* mean rate over each zone's common-domain pixels (854,246 px). "
