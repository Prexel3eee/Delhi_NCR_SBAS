...
METHODS = """### 2.1 Study design and observation period
...
SUPPLEMENT_CALLOUTS = (
    "Independent acquisition geometry and coverage are summarized in (Figure F1). "
...
def _results(evidence: FrozenEvidence) -> str:
    return "\n\n".join(
        [
